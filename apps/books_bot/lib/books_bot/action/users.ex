defmodule BooksBot.Action.Users do
  use BooksBot.Action
  ...
  def list_users do
    Application.get_env(:books_bot, :granted_users, [])
  end
  ...
  def add_user(username) do
    ...
    Application.put_env(:books_bot, :granted_users, granted_users)
  end
